...
assistant = AssistantAgent(
    ...
    system_message="You are a straightforward AI that provides concise summaries.",
...
query = "Go to  https://techcrunch.com/category/artificial-intelligence and read all headlines about agentic ai"
...
async def async_main():
    try: 
        ...
        chat_result = user_proxy.initiate_chat(
            assistant,
            message=f"scan links in following web content: {web_content} and return json format with article link, author and keywords"
        )
